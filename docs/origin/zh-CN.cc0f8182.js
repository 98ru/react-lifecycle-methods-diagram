...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  'i18n/json/zh-CN.json': [function (require, module, exports) {
    module.exports = {
      'React lifecycle methods diagram': 'React 生命周期方法图解',
      Options: '选项',
      'Show less common lifecycles': '展示不常用的生命周期',
      Mounting: '挂载时',
      Updating: '更新时',
      Unmounting: '卸载时',
      '“{name} phase”': '“{name} 阶段”',
      'Pure and has no side effects. May be paused, aborted or restarted by React.': '纯净且不包含副作用。可能会被 React 暂停，中止或重新启动。',
      'Can read the DOM.': '可以读取 DOM。',
      'Can work with DOM, run side effects, schedule updates.': '可以使用 DOM，运行副作用，安排更新。',
...
// # sourceMappingURL=/zh-CN.cc0f8182.js.map
